...
using Lead_Management.Core.Configuration;
using Lead_Management.Core.Helper;
using Lead_Management.Core.Repository;
using Lead_Management.Service.User;
using Lead_Management.Web.FrameWork;
using Lead_Management.Web.Helper;
...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    .AddCookie(options =>
    {
        options.Cookie.Name = "LeadCookie";
...
{
    options.Cookie.Name = "LeadAntiforgeryCookie";
...
builder.Services.AddSession(options =>
{
    ...
    options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
    options.Cookie.Name = "LeadSession";
    options.Cookie.Path = "/";
