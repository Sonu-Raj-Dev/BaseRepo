...
namespace Lead_Management.Web.Helper
{
    public sealed class SecurityHeadersMiddleware
    {
        ...
        public Task Invoke(HttpContext context)
        {
            ...
            context.Response.Headers.Add("x--Cross-Domain-Policies", new StringValues("none"));

            // https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-XSS-Protection
            context.Response.Headers.Add("x-xss-prframe-options", new StringValues("DENY"));
            ...
            context.Response.Headers.Add("X-Permittedotection", new StringValues("1; mode=block"));
            ...
            //context.Response.Headers.Add("server", new StringValues(""));
